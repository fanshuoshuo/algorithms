        ...
        */
        paint: function (option) {
            ...
            if (userFullNameConfig.containerShowLogo) {
                var bdLogo = document.createElement("a");
                bdLogo.innerHTML = "&nbsp;";
                bdLogo.setAttribute("target", "_blank");
                if (window.isGongyi) {
                    bdLogo.setAttribute("href", "http://gongyi.baidu.com/");
                    bdLogo.className = "gyLogo";
                }
                else {
                    bdLogo.setAttribute("href", "http://wangmeng.baidu.com/");
                    bdLogo.className = userFullNameConfig.containerLogoClass || "bdLogo";
                }
                result.appendChild(bdLogo);
        ...
        */
        getVariables: function (userConfig) {
            ...
            for (key in userConfig) {
                paramFullName = this.getFullName(key);
                if (paramFullName) {
            ...
            for (key in userFullNameConfig) {
                if (key && (typeof userFullNameConfig[key] !== "undefined")) {
                    if( typeof userFullNameConfig[key] ==="string" ){
                        userFullNameConfig[key] = userFullNameConfig[key].replace("#","");
                    }
